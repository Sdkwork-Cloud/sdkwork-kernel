...
pub fn claude_code_agent_manifest() -> AgentManifest {
    AgentManifest {
        ...
        description: "SDKWork-standard Claude Code CLI and agent SDK backed code-agent runtime."
            .to_string(),
...
pub fn claude_code_agent_definition() -> AgentDefinition {
    AgentDefinition::new(
        "definition.intelligence.claude-code",
        claude_code_agent_manifest(),
    )
    .with_provider_binding(
        AgentProviderBinding::new(
            "binding.claude-code.model",
