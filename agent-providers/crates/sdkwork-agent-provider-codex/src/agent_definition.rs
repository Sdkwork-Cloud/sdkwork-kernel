...
pub fn codex_agent_manifest() -> AgentManifest {
    AgentManifest {
        ...
        description: "SDKWork-standard Codex app-server and CLI-backed code agent runtime."
            .to_string(),
...
pub fn codex_agent_definition() -> AgentDefinition {
    AgentDefinition::new("definition.intelligence.codex", codex_agent_manifest())
