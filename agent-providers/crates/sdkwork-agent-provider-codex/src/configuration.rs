use crate::{
    ids,
    materializer::{
        dematerialize_codex_model_configuration, materialize_codex_model_configuration,
        materialize_codex_model_selection, read_codex_model_configuration,
    },
};
use sdkwork_agent_kernel::{
    ...
    ProviderHealth, ProviderModelConfigurationStatus, APPROVE_FOR_ME_ACCESS_MODE_ID,
...
impl AgentConfigurationProvider for CodexConfigurationProvider {
    ...
    fn materialize_model_configuration(
        ...
        materialize_codex_model_configuration(request, application)
    }
    ...
    fn materialize_model_selection(
        ...
        materialize_codex_model_selection(request, application)
    }
    ...
    fn dematerialize_model_configuration(
        ...
        dematerialize_codex_model_configuration(agent_id, profile_id)
    }
    ...
    fn read_model_configuration(
        ...
        read_codex_model_configuration()
    }
