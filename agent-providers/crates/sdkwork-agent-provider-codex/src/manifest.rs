use crate::{CodexConfigurationProvider, CodexSdkIntegration};
...
pub fn codex_kernel_plugin_manifest() -> KernelPluginManifest {
    KernelPluginManifest::new(ids::PLUGIN_ID, "Codex", "0.2.0", "process-adapter")
    ...
    fn configure_runtime(&self, builder: RuntimeBuilder) -> RuntimeBuilder {
        ...
        builder
            ...
            .register_agent_configuration(
                ...
                "0.1.0",
                CodexConfigurationProvider::new(),
            )
    }
