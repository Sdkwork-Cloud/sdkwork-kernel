...
pub fn mimo_code_agent_manifest() -> AgentManifest {
    AgentManifest {
        ...
        description: "SDKWork-standard MiMo Code SDK-backed coding agent runtime.".to_string(),
...
pub fn mimo_code_agent_definition() -> AgentDefinition {
    AgentDefinition::new(
        "definition.intelligence.mimo-code",
        mimo_code_agent_manifest(),
    )
    .with_provider_binding(
        AgentProviderBinding::new(
            "binding.mimo-code.model",
    ...
    .with_model_selection(
        ModelSelectionPolicy::default_provider(ids::MODEL_PROVIDER_ID)
            .with_default_model_id("mimo-v2.5-pro")
