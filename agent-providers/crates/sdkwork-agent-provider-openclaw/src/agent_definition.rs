...
pub fn openclaw_agent_manifest() -> AgentManifest {
    AgentManifest {
        ...
        description: "SDKWork-standard OpenClaw gateway-backed general agent runtime.".to_string(),
        ...
        optional_capability_requirements: vec![CapabilityRequirement::new("tool.invoke")
...
pub fn openclaw_agent_definition() -> AgentDefinition {
    AgentDefinition::new("definition.intelligence.openclaw", openclaw_agent_manifest())
        .with_provider_binding(
            AgentProviderBinding::new(
                "binding.openclaw.model",
        ...
        .with_model_selection(
            ModelSelectionPolicy::default_provider(ids::MODEL_PROVIDER_ID)
                .with_default_model_id("openclaw-default")
