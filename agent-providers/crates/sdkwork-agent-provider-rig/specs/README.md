...
This directory is the local SDKWork component contract for `sdkwork-agent-provider-rig`.

- Component root: `sdkwork-kernel/agent-providers/crates/sdkwork-agent-provider-rig`
