...
- [TECH-2026-06-14-multi-mode-agent-system.md](tech/TECH-2026-06-14-multi-mode-agent-system.md) — client modes, kernel plugins, bridge plugins
- [TECH-topology-standard.md](tech/TECH-topology-standard.md) — production topology, ingress, Postgres/Redis
- [TECH-2026-06-04-external-agent-plugins.md](tech/TECH-2026-06-04-external-agent-plugins.md) — adapter/plugin matrix
