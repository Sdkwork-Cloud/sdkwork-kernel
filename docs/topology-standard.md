...
`SDKWORK_KERNEL_AGENT_PLUGIN` selects the kernel agent plugin inside `sdkwork-agent-server`:
...
See `sdkwork-agent-server/src/runtime_bootstrap.rs` and `docs/architecture/tech/TECH-2026-06-14-multi-mode-agent-system.md`.
