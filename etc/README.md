# sdkwork-kernel Source Configuration
...
| `runtimeCode` | `kernel` |
| Config root | `/etc/sdkwork/kernel/` |
| Runtime TOML | `/etc/sdkwork/kernel/config.toml` |
| Secrets | `/etc/sdkwork/kernel/secrets/` |
| Override | `SDKWORK_KERNEL_CONFIG_FILE` |
