...
This directory is the local SDKWork component contract for `@sdkwork/agent-backend-sdk`.

- Component root: `sdkwork-kernel/sdks/sdkwork-agent-backend-sdk/sdkwork-agent-backend-sdk-typescript`
