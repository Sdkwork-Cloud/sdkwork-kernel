...
```bash
npm install @sdkwork/agent-internal-sdk
# or
yarn add @sdkwork/agent-internal-sdk
# or
pnpm add @sdkwork/agent-internal-sdk
```

## Quick Start

```typescript
import { SdkworkCustomClient } from '@sdkwork/agent-internal-sdk';
