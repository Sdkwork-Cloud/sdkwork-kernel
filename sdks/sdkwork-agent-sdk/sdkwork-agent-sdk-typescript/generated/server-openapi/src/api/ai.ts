...
/** Upsert an agent memory retrieval index */
  async upsert(body: UpsertMemoryRetrievalIndexRequest, params: AiMemoryRetrievalIndexesUpsertParams): Promise<MemoryRetrievalIndexResponse> {
    ...
    return this.client.post<MemoryRetrievalIndexResponse>(appendQueryString(agentApiPath(`/ai/memory_retrieval_indexes`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** Create a graph relation for one agent memory record */
  async create(memoryId: string, body: CreateMemoryRelationRequest, params: AiMemoryRelationsCreateParams): Promise<MemoryRelationResponse> {
    ...
    return this.client.post<MemoryRelationResponse>(appendQueryString(agentApiPath(`/ai/memory_records/${serializePathParameter(memoryId, { name: 'memoryId', style: 'simple', explode: false })}/relations`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** Create a provenance source for one agent memory record */
  async create(memoryId: string, body: CreateMemorySourceRequest, params: AiMemorySourcesCreateParams): Promise<MemorySourceResponse> {
    ...
    return this.client.post<MemorySourceResponse>(appendQueryString(agentApiPath(`/ai/memory_records/${serializePathParameter(memoryId, { name: 'memoryId', style: 'simple', explode: false })}/sources`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** Create an agent memory record in one namespace */
  async create(memoryNamespaceId: string, body: CreateMemoryRecordRequest, params: AiMemoryRecordsCreateParams): Promise<MemoryRecordResponse> {
    ...
    return this.client.post<MemoryRecordResponse>(appendQueryString(agentApiPath(`/ai/memory_namespaces/${serializePathParameter(memoryNamespaceId, { name: 'memoryNamespaceId', style: 'simple', explode: false })}/records`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent memory record */
  async retrieve(memoryId: string, params: AiMemoryRecordsRetrieveParams): Promise<MemoryRecordResponse> {
    ...
    return this.client.get<MemoryRecordResponse>(appendQueryString(agentApiPath(`/ai/memory_records/${serializePathParameter(memoryId, { name: 'memoryId', style: 'simple', explode: false })}`), query));
  }
...
/** Restore one soft-deleted agent memory record */
  async restore(memoryId: string, body: RestoreAgentRequest, params: AiMemoryRecordsRestoreParams): Promise<MemoryRecordResponse> {
    ...
    return this.client.post<MemoryRecordResponse>(appendQueryString(agentApiPath(`/ai/memory_records/${serializePathParameter(memoryId, { name: 'memoryId', style: 'simple', explode: false })}/restore`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** Create an agent memory namespace */
  async create(body: CreateMemoryNamespaceRequest, params: AiMemoryNamespacesCreateParams): Promise<MemoryNamespaceResponse> {
    ...
    return this.client.post<MemoryNamespaceResponse>(appendQueryString(agentApiPath(`/ai/memory_namespaces`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent memory namespace */
  async retrieve(memoryNamespaceId: string, params: AiMemoryNamespacesRetrieveParams): Promise<MemoryNamespaceResponse> {
    ...
    return this.client.get<MemoryNamespaceResponse>(appendQueryString(agentApiPath(`/ai/memory_namespaces/${serializePathParameter(memoryNamespaceId, { name: 'memoryNamespaceId', style: 'simple', explode: false })}`), query));
  }
}
...
/** Create an agent memory profile binding */
  async create(memoryProfileId: string, body: CreateMemoryBindingRequest, params: AiMemoryBindingsCreateParams): Promise<MemoryBindingResponse> {
    ...
    return this.client.post<MemoryBindingResponse>(appendQueryString(agentApiPath(`/ai/memory_profiles/${serializePathParameter(memoryProfileId, { name: 'memoryProfileId', style: 'simple', explode: false })}/bindings`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent memory binding */
  async retrieve(memoryBindingId: string, params: AiMemoryBindingsRetrieveParams): Promise<MemoryBindingResponse> {
    ...
    return this.client.get<MemoryBindingResponse>(appendQueryString(agentApiPath(`/ai/memory_bindings/${serializePathParameter(memoryBindingId, { name: 'memoryBindingId', style: 'simple', explode: false })}`), query));
  }
}
...
/** Create an agent memory profile for one store */
  async create(memoryStoreId: string, body: CreateMemoryProfileRequest, params: AiMemoryProfilesCreateParams): Promise<MemoryProfileResponse> {
    ...
    return this.client.post<MemoryProfileResponse>(appendQueryString(agentApiPath(`/ai/memory_stores/${serializePathParameter(memoryStoreId, { name: 'memoryStoreId', style: 'simple', explode: false })}/profiles`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent memory profile */
  async retrieve(memoryProfileId: string, params: AiMemoryProfilesRetrieveParams): Promise<MemoryProfileResponse> {
    ...
    return this.client.get<MemoryProfileResponse>(appendQueryString(agentApiPath(`/ai/memory_profiles/${serializePathParameter(memoryProfileId, { name: 'memoryProfileId', style: 'simple', explode: false })}`), query));
  }
}
...
/** Create an agent memory store */
  async create(body: CreateMemoryStoreRequest, params: AiMemoryStoresCreateParams): Promise<MemoryStoreResponse> {
    ...
    return this.client.post<MemoryStoreResponse>(appendQueryString(agentApiPath(`/ai/memory_stores`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent memory store */
  async retrieve(memoryStoreId: string, params: AiMemoryStoresRetrieveParams): Promise<MemoryStoreResponse> {
    ...
    return this.client.get<MemoryStoreResponse>(appendQueryString(agentApiPath(`/ai/memory_stores/${serializePathParameter(memoryStoreId, { name: 'memoryStoreId', style: 'simple', explode: false })}`), query));
  }
...
/** Update one agent memory store */
  async update(memoryStoreId: string, body: UpdateMemoryStoreRequest, params: AiMemoryStoresUpdateParams): Promise<MemoryStoreResponse> {
    ...
    return this.client.patch<MemoryStoreResponse>(appendQueryString(agentApiPath(`/ai/memory_stores/${serializePathParameter(memoryStoreId, { name: 'memoryStoreId', style: 'simple', explode: false })}`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** Create a sync job for one agent knowledge base */
  async create(knowledgeBaseId: string, body: CreateKnowledgeSyncJobRequest, params: AiKnowledgeSyncJobsCreateParams): Promise<KnowledgeSyncJobResponse> {
    ...
    return this.client.post<KnowledgeSyncJobResponse>(appendQueryString(agentApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/sync_jobs`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent knowledge sync job */
  async retrieve(syncJobId: string, params: AiKnowledgeSyncJobsRetrieveParams): Promise<KnowledgeSyncJobResponse> {
    ...
    return this.client.get<KnowledgeSyncJobResponse>(appendQueryString(agentApiPath(`/ai/knowledge_sync_jobs/${serializePathParameter(syncJobId, { name: 'syncJobId', style: 'simple', explode: false })}`), query));
  }
...
/** Start one agent knowledge sync job */
  async start(syncJobId: string, body: StartKnowledgeSyncJobRequest, params: AiKnowledgeSyncJobsStartParams): Promise<KnowledgeSyncJobResponse> {
    ...
    return this.client.post<KnowledgeSyncJobResponse>(appendQueryString(agentApiPath(`/ai/knowledge_sync_jobs/${serializePathParameter(syncJobId, { name: 'syncJobId', style: 'simple', explode: false })}/start`), query), body, undefined, undefined, 'application/json');
  }
...
/** Complete one agent knowledge sync job */
  async complete(syncJobId: string, body: CompleteKnowledgeSyncJobRequest, params: AiKnowledgeSyncJobsCompleteParams): Promise<KnowledgeSyncJobResponse> {
    ...
    return this.client.post<KnowledgeSyncJobResponse>(appendQueryString(agentApiPath(`/ai/knowledge_sync_jobs/${serializePathParameter(syncJobId, { name: 'syncJobId', style: 'simple', explode: false })}/complete`), query), body, undefined, undefined, 'application/json');
  }
...
/** Fail one agent knowledge sync job */
  async fail(syncJobId: string, body: FailKnowledgeSyncJobRequest, params: AiKnowledgeSyncJobsFailParams): Promise<KnowledgeSyncJobResponse> {
    ...
    return this.client.post<KnowledgeSyncJobResponse>(appendQueryString(agentApiPath(`/ai/knowledge_sync_jobs/${serializePathParameter(syncJobId, { name: 'syncJobId', style: 'simple', explode: false })}/fail`), query), body, undefined, undefined, 'application/json');
  }
...
/** Cancel one agent knowledge sync job */
  async cancel(syncJobId: string, body: CancelKnowledgeSyncJobRequest, params: AiKnowledgeSyncJobsCancelParams): Promise<KnowledgeSyncJobResponse> {
    ...
    return this.client.post<KnowledgeSyncJobResponse>(appendQueryString(agentApiPath(`/ai/knowledge_sync_jobs/${serializePathParameter(syncJobId, { name: 'syncJobId', style: 'simple', explode: false })}/cancel`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** Create a binding for one agent knowledge base */
  async create(knowledgeBaseId: string, body: CreateKnowledgeBindingRequest, params: AiKnowledgeBindingsCreateParams): Promise<KnowledgeBindingResponse> {
    ...
    return this.client.post<KnowledgeBindingResponse>(appendQueryString(agentApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/bindings`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent knowledge binding */
  async retrieve(knowledgeBindingId: string, params: AiKnowledgeBindingsRetrieveParams): Promise<KnowledgeBindingResponse> {
    ...
    return this.client.get<KnowledgeBindingResponse>(appendQueryString(agentApiPath(`/ai/knowledge_bindings/${serializePathParameter(knowledgeBindingId, { name: 'knowledgeBindingId', style: 'simple', explode: false })}`), query));
  }
}
...
/** Upsert an agent knowledge retrieval index */
  async upsert(body: UpsertKnowledgeIndexRequest, params: AiKnowledgeIndexesUpsertParams): Promise<KnowledgeIndexResponse> {
    ...
    return this.client.post<KnowledgeIndexResponse>(appendQueryString(agentApiPath(`/ai/knowledge_indexes`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent knowledge retrieval index */
  async retrieve(knowledgeIndexId: string, params: AiKnowledgeIndexesRetrieveParams): Promise<KnowledgeIndexResponse> {
    ...
    return this.client.get<KnowledgeIndexResponse>(appendQueryString(agentApiPath(`/ai/knowledge_indexes/${serializePathParameter(knowledgeIndexId, { name: 'knowledgeIndexId', style: 'simple', explode: false })}`), query));
  }
}
...
/** Create a chunk for one agent knowledge document */
  async create(knowledgeDocumentId: string, body: CreateKnowledgeChunkRequest, params: AiKnowledgeChunksCreateParams): Promise<KnowledgeChunkResponse> {
    ...
    return this.client.post<KnowledgeChunkResponse>(appendQueryString(agentApiPath(`/ai/knowledge_documents/${serializePathParameter(knowledgeDocumentId, { name: 'knowledgeDocumentId', style: 'simple', explode: false })}/chunks`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent knowledge chunk */
  async retrieve(knowledgeChunkId: string, params: AiKnowledgeChunksRetrieveParams): Promise<KnowledgeChunkResponse> {
    ...
    return this.client.get<KnowledgeChunkResponse>(appendQueryString(agentApiPath(`/ai/knowledge_chunks/${serializePathParameter(knowledgeChunkId, { name: 'knowledgeChunkId', style: 'simple', explode: false })}`), query));
  }
}
...
/** Read one provider-neutral knowledge document */
  async read(knowledgeDocumentId: string, params: AiKnowledgeReadReadParams): Promise<KnowledgeDocumentResponse> {
    ...
    return this.client.get<KnowledgeDocumentResponse>(appendQueryString(agentApiPath(`/ai/knowledge_documents/${serializePathParameter(knowledgeDocumentId, { name: 'knowledgeDocumentId', style: 'simple', explode: false })}`), query));
  }
}
...
/** Search an agent knowledge base for provider-neutral RAG candidates */
  async search(knowledgeBaseId: string, body: SearchKnowledgeRequest, params: AiKnowledgeSearchSearchParams): Promise<KnowledgeSearchResponse> {
    ...
    return this.client.post<KnowledgeSearchResponse>(appendQueryString(agentApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/search`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** Create a document for one agent knowledge base */
  async create(knowledgeBaseId: string, body: CreateKnowledgeDocumentRequest, params: AiKnowledgeDocumentsCreateParams): Promise<KnowledgeDocumentResponse> {
    ...
    return this.client.post<KnowledgeDocumentResponse>(appendQueryString(agentApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/documents`), query), body, undefined, undefined, 'application/json');
  }
...
/** Update one agent knowledge document */
  async update(knowledgeDocumentId: string, body: UpdateKnowledgeDocumentRequest, params: AiKnowledgeDocumentsUpdateParams): Promise<KnowledgeDocumentResponse> {
    ...
    return this.client.patch<KnowledgeDocumentResponse>(appendQueryString(agentApiPath(`/ai/knowledge_documents/${serializePathParameter(knowledgeDocumentId, { name: 'knowledgeDocumentId', style: 'simple', explode: false })}`), query), body, undefined, undefined, 'application/json');
  }
...
/** Restore one soft-deleted agent knowledge document */
  async restore(knowledgeDocumentId: string, body: RestoreAgentRequest, params: AiKnowledgeDocumentsRestoreParams): Promise<KnowledgeDocumentResponse> {
    ...
    return this.client.post<KnowledgeDocumentResponse>(appendQueryString(agentApiPath(`/ai/knowledge_documents/${serializePathParameter(knowledgeDocumentId, { name: 'knowledgeDocumentId', style: 'simple', explode: false })}/restore`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** Create a source for one agent knowledge base */
  async create(knowledgeBaseId: string, body: CreateKnowledgeSourceRequest, params: AiKnowledgeSourcesCreateParams): Promise<KnowledgeSourceResponse> {
    ...
    return this.client.post<KnowledgeSourceResponse>(appendQueryString(agentApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/sources`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent knowledge source */
  async retrieve(knowledgeSourceId: string, params: AiKnowledgeSourcesRetrieveParams): Promise<KnowledgeSourceResponse> {
    ...
    return this.client.get<KnowledgeSourceResponse>(appendQueryString(agentApiPath(`/ai/knowledge_sources/${serializePathParameter(knowledgeSourceId, { name: 'knowledgeSourceId', style: 'simple', explode: false })}`), query));
  }
...
/** Update one agent knowledge source */
  async update(knowledgeSourceId: string, body: UpdateKnowledgeSourceRequest, params: AiKnowledgeSourcesUpdateParams): Promise<KnowledgeSourceResponse> {
    ...
    return this.client.patch<KnowledgeSourceResponse>(appendQueryString(agentApiPath(`/ai/knowledge_sources/${serializePathParameter(knowledgeSourceId, { name: 'knowledgeSourceId', style: 'simple', explode: false })}`), query), body, undefined, undefined, 'application/json');
  }
...
/** Restore one soft-deleted agent knowledge source */
  async restore(knowledgeSourceId: string, body: RestoreAgentRequest, params: AiKnowledgeSourcesRestoreParams): Promise<KnowledgeSourceResponse> {
    ...
    return this.client.post<KnowledgeSourceResponse>(appendQueryString(agentApiPath(`/ai/knowledge_sources/${serializePathParameter(knowledgeSourceId, { name: 'knowledgeSourceId', style: 'simple', explode: false })}/restore`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** Create an agent knowledge base */
  async create(body: CreateKnowledgeBaseRequest, params: AiKnowledgeBasesCreateParams): Promise<KnowledgeBaseResponse> {
    ...
    return this.client.post<KnowledgeBaseResponse>(appendQueryString(agentApiPath(`/ai/knowledge_bases`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one agent knowledge base */
  async retrieve(knowledgeBaseId: string, params: AiKnowledgeBasesRetrieveParams): Promise<KnowledgeBaseResponse> {
    ...
    return this.client.get<KnowledgeBaseResponse>(appendQueryString(agentApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}`), query));
  }
...
/** Update one agent knowledge base */
  async update(knowledgeBaseId: string, body: UpdateKnowledgeBaseRequest, params: AiKnowledgeBasesUpdateParams): Promise<KnowledgeBaseResponse> {
    ...
    return this.client.patch<KnowledgeBaseResponse>(appendQueryString(agentApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}`), query), body, undefined, undefined, 'application/json');
  }
...
/** Restore one soft-deleted agent knowledge base */
  async restore(knowledgeBaseId: string, body: RestoreAgentRequest, params: AiKnowledgeBasesRestoreParams): Promise<KnowledgeBaseResponse> {
    ...
    return this.client.post<KnowledgeBaseResponse>(appendQueryString(agentApiPath(`/ai/knowledge_bases/${serializePathParameter(knowledgeBaseId, { name: 'knowledgeBaseId', style: 'simple', explode: false })}/restore`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** Create a prompt optimization for one managed agent */
  async create(agentId: string, body: CreateAgentPromptOptimizationRequest, params: AiAgentsPromptOptimizationsCreateParams): Promise<AgentRuntimeExecutionResponse> {
    ...
    return this.client.post<AgentRuntimeExecutionResponse>(appendQueryString(agentApiPath(`/ai/agents/${serializePathParameter(agentId, { name: 'agentId', style: 'simple', explode: false })}/prompt_optimizations`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** Create a preview response for one managed agent */
  async create(agentId: string, body: CreateAgentPreviewResponseRequest, params: AiAgentsPreviewResponsesCreateParams): Promise<AgentRuntimeExecutionResponse> {
    ...
    return this.client.post<AgentRuntimeExecutionResponse>(appendQueryString(agentApiPath(`/ai/agents/${serializePathParameter(agentId, { name: 'agentId', style: 'simple', explode: false })}/preview_responses`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** Create a deployment snapshot for one managed agent provider binding */
  async create(agentId: string, body: CreateAgentDeploymentRequest, params: AiAgentsDeploymentsCreateParams): Promise<AgentDeploymentResponse> {
    ...
    return this.client.post<AgentDeploymentResponse>(appendQueryString(agentApiPath(`/ai/agents/${serializePathParameter(agentId, { name: 'agentId', style: 'simple', explode: false })}/deployments`), query), body, undefined, undefined, 'application/json');
  }
}
...
/** Create a provider binding for one managed agent */
  async create(agentId: string, body: CreateAgentProviderBindingRequest, params: AiAgentsProviderBindingsCreateParams): Promise<AgentProviderBindingResponse> {
    ...
    return this.client.post<AgentProviderBindingResponse>(appendQueryString(agentApiPath(`/ai/agents/${serializePathParameter(agentId, { name: 'agentId', style: 'simple', explode: false })}/provider_bindings`), query), body, undefined, undefined, 'application/json');
  }
...
/** Create a managed agent */
  async create(body: CreateAgentRequest, params: AiAgentsCreateParams): Promise<AgentResponse> {
    ...
    return this.client.post<AgentResponse>(appendQueryString(agentApiPath(`/ai/agents`), query), body, undefined, undefined, 'application/json');
  }
...
/** Retrieve one managed agent */
  async retrieve(agentId: string, params: AiAgentsRetrieveParams): Promise<AgentResponse> {
    ...
    return this.client.get<AgentResponse>(appendQueryString(agentApiPath(`/ai/agents/${serializePathParameter(agentId, { name: 'agentId', style: 'simple', explode: false })}`), query));
  }
...
/** Update one managed agent */
  async update(agentId: string, body: UpdateAgentRequest, params: AiAgentsUpdateParams): Promise<AgentResponse> {
    ...
    return this.client.patch<AgentResponse>(appendQueryString(agentApiPath(`/ai/agents/${serializePathParameter(agentId, { name: 'agentId', style: 'simple', explode: false })}`), query), body, undefined, undefined, 'application/json');
  }
...
/** Soft-delete one managed agent */
  async delete(agentId: string, params: AiAgentsDeleteParams): Promise<AgentResponse> {
    ...
    return this.client.delete<AgentResponse>(appendQueryString(agentApiPath(`/ai/agents/${serializePathParameter(agentId, { name: 'agentId', style: 'simple', explode: false })}`), query));
  }
...
/** Restore one soft-deleted managed agent */
  async restore(agentId: string, body: RestoreAgentRequest, params: AiAgentsRestoreParams): Promise<AgentResponse> {
    ...
    return this.client.post<AgentResponse>(appendQueryString(agentApiPath(`/ai/agents/${serializePathParameter(agentId, { name: 'agentId', style: 'simple', explode: false })}/restore`), query), body, undefined, undefined, 'application/json');
  }
}
