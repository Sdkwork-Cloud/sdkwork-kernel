...
This directory is the local SDKWork component contract for `@sdkwork/agent-sdk`.

- Component root: `sdkwork-kernel/sdks/sdkwork-agent-sdk/sdkwork-agent-sdk-typescript`
