...
pub use persistence::{
    ...
    SQL_UPDATE_AGENT_MCP_SERVER, SQL_UPDATE_AGENT_MEMORY_BINDING, SQL_UPDATE_AGENT_MEMORY_NAMESPACE,
    SQL_UPDATE_AGENT_MEMORY_PROFILE, SQL_UPDATE_AGENT_MEMORY_RECORD, SQL_UPDATE_AGENT_MEMORY_STORE,
