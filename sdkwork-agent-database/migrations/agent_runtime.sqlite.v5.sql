-- Durable task/run/step execution and permission resume (SQLite, migration v5).
...
CREATE TABLE IF NOT EXISTS steps (
    ...
    FOREIGN KEY (causation_step_id) REFERENCES steps(step_id) ON DELETE SET NULL
);
