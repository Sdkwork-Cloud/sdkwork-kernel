...
This directory is the local SDKWork component contract for `sdkwork-agent-integration-core`.

- Component root: `sdkwork-kernel/sdkwork-agent-integrations/crates/sdkwork-agent-integration-core`
