...
pub struct HermesLifecycleProvider {
    sessions: Mutex<HashMap<String, AgentSession>>,
}

impl HermesLifecycleProvider {
    pub fn new() -> Self {
        Self {
...
impl Default for HermesLifecycleProvider {
    fn default() -> Self {
        Self::new()
    }
}

impl SessionLifecycleProvider for HermesLifecycleProvider {
    fn create_session(
        &self,
        agent_id: &str,
        user_ref: Option<&str>,
        ...
        let session_id = format!("hermes.{}", uuid_simple());
