...
pub struct MiMoCodeLifecycleProvider {
    sessions: Mutex<HashMap<String, AgentSession>>,
}

impl MiMoCodeLifecycleProvider {
    pub fn new() -> Self {
        Self {
...
impl Default for MiMoCodeLifecycleProvider {
    fn default() -> Self {
        Self::new()
    }
}

impl SessionLifecycleProvider for MiMoCodeLifecycleProvider {
    fn create_session(
        &self,
        agent_id: &str,
        user_ref: Option<&str>,
        ...
        let session_id = format!("mimo.{}", uuid_simple());
