...
This directory is the local SDKWork component contract for `sdkwork-agent-plugin-rig`.

- Component root: `sdkwork-kernel/sdkwork-kernel-plugins/crates/sdkwork-agent-plugin-rig`
