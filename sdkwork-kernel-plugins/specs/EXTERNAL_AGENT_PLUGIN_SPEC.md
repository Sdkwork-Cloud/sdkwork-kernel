# SDKWork External Agent Plugin Specification
...
| Gemini CLI | code-agent CLI/runtime | Model/tool adapter, command workflow |
...
External plugins MUST NOT claim local-runtime compatibility until typed
