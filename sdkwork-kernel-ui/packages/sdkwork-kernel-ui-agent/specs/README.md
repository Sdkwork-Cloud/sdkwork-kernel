# SDKWork Kernel UI Agent Component Specs

This directory is the local standards index for `@sdkwork/kernel-ui-agent`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/kernel-ui-agent` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/kernel/sdkwork-kernel-ui/packages/sdkwork-kernel-ui-agent` |
| Domain | `intelligence` |
| Capability | `agent` |
...
- `pnpm --filter @sdkwork/kernel-ui-agent typecheck`
