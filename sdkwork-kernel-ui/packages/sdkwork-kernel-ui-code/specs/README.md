# SDKWork Kernel UI Code Component Specs

This directory is the local standards index for `@sdkwork/kernel-ui-code`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/kernel-ui-code` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/kernel/sdkwork-kernel-ui/packages/sdkwork-kernel-ui-code` |
| Domain | `platform` |
...
- `pnpm --filter @sdkwork/kernel-ui-code typecheck`
