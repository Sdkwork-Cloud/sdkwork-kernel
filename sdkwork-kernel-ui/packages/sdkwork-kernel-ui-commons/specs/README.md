# SDKWork Kernel UI Commons Component Specs

This directory is the local standards index for `@sdkwork/kernel-ui-commons`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/kernel-ui-commons` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/kernel/sdkwork-kernel-ui/packages/sdkwork-kernel-ui-commons` |
| Domain | `platform` |
...
- `pnpm --filter @sdkwork/kernel-ui-commons typecheck`
