...
This README is the SDKWork module entrypoint for `@sdkwork/kernel-ui-permissions`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../sdkwork-specs/`.
...
- `pnpm --filter @sdkwork/kernel-ui-permissions typecheck`
