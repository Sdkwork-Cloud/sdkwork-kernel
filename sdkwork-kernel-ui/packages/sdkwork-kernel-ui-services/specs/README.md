# SDKWork Kernel UI Services Component Specs

This directory is the local standards index for `@sdkwork/kernel-ui-services`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/kernel-ui-services` |
| Type | `node-package` |
| Root | `sdkwork-birdcoder/kernel/sdkwork-kernel-ui/packages/sdkwork-kernel-ui-services` |
| Domain | `platform` |
