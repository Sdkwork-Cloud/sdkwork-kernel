# SDKWork Kernel UI Telemetry Component Specs

This directory is the local standards index for `@sdkwork/kernel-ui-telemetry`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/kernel-ui-telemetry` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/kernel/sdkwork-kernel-ui/packages/sdkwork-kernel-ui-telemetry` |
| Domain | `platform` |
...
- `pnpm --filter @sdkwork/kernel-ui-telemetry typecheck`
