# SDKWork Kernel UI Terminal Component Specs

This directory is the local standards index for `@sdkwork/kernel-ui-terminal`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/kernel-ui-terminal` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/kernel/sdkwork-kernel-ui/packages/sdkwork-kernel-ui-terminal` |
| Domain | `content` |
...
- `pnpm --filter @sdkwork/kernel-ui-terminal typecheck`
