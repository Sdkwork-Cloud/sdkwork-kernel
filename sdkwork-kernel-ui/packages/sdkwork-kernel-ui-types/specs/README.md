# SDKWork Kernel UI Types Component Specs

This directory is the local standards index for `@sdkwork/kernel-ui-types`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/kernel-ui-types` |
| Type | `node-package` |
| Root | `sdkwork-birdcoder/kernel/sdkwork-kernel-ui/packages/sdkwork-kernel-ui-types` |
| Domain | `platform` |
...
- `pnpm --filter @sdkwork/kernel-ui-types typecheck`
