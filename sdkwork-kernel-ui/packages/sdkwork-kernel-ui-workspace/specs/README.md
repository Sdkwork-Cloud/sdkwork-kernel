# SDKWork Kernel UI Workspace Component Specs

This directory is the local standards index for `@sdkwork/kernel-ui-workspace`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/kernel-ui-workspace` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/kernel/sdkwork-kernel-ui/packages/sdkwork-kernel-ui-workspace` |
| Domain | `platform` |
...
- `pnpm --filter @sdkwork/kernel-ui-workspace typecheck`
