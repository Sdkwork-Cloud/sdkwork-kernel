# SDKWork Kernel UI Standard Component Specs

This directory is the local standards index for `@sdkwork/kernel-ui-standard`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/kernel-ui-standard` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/kernel/sdkwork-kernel-ui` |
| Domain | `platform` |
